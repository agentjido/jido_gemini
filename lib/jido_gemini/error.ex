defmodule Jido.Gemini.Error do
  @moduledoc """
  Centralized error handling for Jido.Gemini.
  """
  ...
  defmodule ExecutionFailureError do
    @moduledoc "Raised when Gemini execution fails."
    @type t :: %__MODULE__{message: String.t() | nil, details: term()}
    defexception [:message, :details]
  end

  defmodule ConfigError do
    @moduledoc "Raised when Gemini runtime configuration is invalid."
